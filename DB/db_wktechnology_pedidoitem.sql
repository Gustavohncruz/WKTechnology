...
CREATE TABLE `pedidoitem` (
  ...
  `VALORUNIT` decimal(14,2) DEFAULT '0.00',
  `VALORTOTAL` decimal(14,2) DEFAULT '0.00',
  ...
  CONSTRAINT `FK_NUMPEDIDO` FOREIGN KEY (`NUMPEDIDO`) REFERENCES `pedido` (`NUMPEDIDO`) ON DELETE CASCADE
